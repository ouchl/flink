...
import org.apache.flink.connector.mysql.internal.JdbcBatchingOutputFormat;
import org.apache.flink.connector.mysql.internal.connection.SimpleJdbcConnectionProvider;
import org.apache.flink.connector.mysql.internal.converter.JdbcRowConverter;
import org.apache.flink.connector.mysql.internal.executor.JdbcBatchStatementExecutor;
import org.apache.flink.connector.mysql.internal.executor.TableBufferReducedStatementExecutor;
import org.apache.flink.connector.mysql.internal.executor.TableBufferedStatementExecutor;
import org.apache.flink.connector.mysql.internal.executor.TableInsertOrUpdateStatementExecutor;
import org.apache.flink.connector.mysql.internal.executor.TableSimpleStatementExecutor;
...
import org.apache.flink.connector.mysql.statement.FieldNamedPreparedStatement;
...
public class JdbcDynamicOutputFormatBuilder implements Serializable {
    ...
    private static JdbcBatchStatementExecutor<RowData> createBufferReduceExecutor(
        ...
        JdbcBatchStatementExecutor<RowData> deleteExe =
                dialect.dialectName().equals("MySQL2")
                        ? null

 ...
 */
@Experimental
public class VerticaNumericBetweenParametersProvider implements VerticaParameterValuesProvider {
	 ...
	 */
	public VerticaNumericBetweenParametersProvider(long minVal, long maxVal) {
	 ...
	 * @param maxVal the upper bound of the produced "to" values
	 */
	public VerticaNumericBetweenParametersProvider(long fetchSize, long minVal, long maxVal) {
		Preconditions.checkArgument(minVal <= maxVal, "minVal must not be larger than maxVal");
		this.minVal = minVal;
		this.maxVal = maxVal;
	...
	public VerticaNumericBetweenParametersProvider ofBatchSize(long batchSize) {
	...
	public VerticaNumericBetweenParametersProvider ofBatchNum(int batchNum) {

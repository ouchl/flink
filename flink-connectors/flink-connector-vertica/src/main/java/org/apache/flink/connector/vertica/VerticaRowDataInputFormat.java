...
/**
 * InputFormat for {@link VerticaDynamicTableSource}.
 */
@Internal
public class VerticaRowDataInputFormat extends RichInputFormat<RowData, InputSplit> implements ResultTypeQueryable<RowData> {

	private static final long serialVersionUID = 1L;
	private static final Logger LOG = LoggerFactory.getLogger(VerticaRowDataInputFormat.class);

	private VerticaConnectionOptions connectionOptions;
	...
	private VerticaRowConverter rowConverter;
	...
	private VerticaRowDataInputFormat(
			VerticaConnectionOptions connectionOptions,
			int fetchSize,
			Boolean autoCommit,
			...
			VerticaRowConverter rowConverter,
	...
	public void openInputFormat() {
		...
		try {
			dbConn = new VerticaConnectionProvider(connectionOptions).getConnection();
			...
			throw new IllegalArgumentException("Vertica-Class not found. - " + cnfe.getMessage(), cnfe);
		}
	}
	...
	/**
	 * Builder for {@link VerticaRowDataInputFormat}.
	 */
	public static class Builder {
		private VerticaConnectionOptions.VerticaConnectionOptionsBuilder connOptionsBuilder;
		private int fetchSize;
		private Boolean autoCommit;
		private Object[][] parameterValues;
		private String queryTemplate;
		...
		public Builder() {
			this.connOptionsBuilder = new VerticaConnectionOptions.VerticaConnectionOptionsBuilder();
		}
		...
		public Builder setParametersProvider(VerticaParameterValuesProvider parameterValuesProvider) {
		...
		public Builder setRowConverter(VerticaRowConverter rowConverter) {
			this.rowConverter = rowConverter;
			return this;
		}
		...
		public VerticaRowDataInputFormat build() {
			...
			return new VerticaRowDataInputFormat(

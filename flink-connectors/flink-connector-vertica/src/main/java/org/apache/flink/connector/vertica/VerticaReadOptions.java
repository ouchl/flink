...
public class VerticaReadOptions implements Serializable {
	...
	public boolean equals(Object o) {
		if (o instanceof VerticaReadOptions) {
			VerticaReadOptions options = (VerticaReadOptions) o;
	...
	/**
	 * Builder of {@link VerticaReadOptions}.
	 */
	public static class Builder {
		...
		public VerticaReadOptions build() {
			return new VerticaReadOptions(

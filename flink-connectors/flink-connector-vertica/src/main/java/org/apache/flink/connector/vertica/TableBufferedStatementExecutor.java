 ...
 */
public final class TableBufferedStatementExecutor implements VerticaBufferedBatchStatementExecutor<RowData> {

	private final VerticaBatchStatementExecutor<RowData> statementExecutor;
	private final Function<RowData, RowData> valueTransform;
	private final List<RowData> buffer = new ArrayList<>();

	public TableBufferedStatementExecutor(
		VerticaBatchStatementExecutor<RowData> statementExecutor,

 ...
 */
@Internal
public class VerticaDynamicTableSink implements DynamicTableSink {

	private final VerticaOptions verticaOptions;
	private final VerticaExecutionOptions executionOptions;
	private final VerticaDmlOptions dmlOptions;
	private final TableSchema tableSchema;

	public VerticaDynamicTableSink(
		VerticaOptions verticaOptions,
	...
	public SinkRuntimeProvider getSinkRuntimeProvider(Context context) {
		...
		final VerticaDynamicOutputFormatBuilder builder = new VerticaDynamicOutputFormatBuilder();

		builder.setVerticaOptions(verticaOptions);
		builder.setVerticaDmlOptions(dmlOptions);
		builder.setVerticaExecutionOptions(executionOptions);
	...
	public DynamicTableSink copy() {
		return new VerticaDynamicTableSink(verticaOptions, executionOptions, dmlOptions, tableSchema);
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof VerticaDynamicTableSink)) {
			return false;
		}
		VerticaDynamicTableSink that = (VerticaDynamicTableSink) o;
		return Objects.equals(verticaOptions, that.verticaOptions) &&
	...
	@Override
	public int hashCode() {
		return Objects.hash(verticaOptions, executionOptions, dmlOptions, tableSchema);
	}
}

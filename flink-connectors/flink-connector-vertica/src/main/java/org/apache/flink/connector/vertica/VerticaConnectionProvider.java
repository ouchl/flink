...
public class VerticaConnectionProvider implements Serializable {

	private static final Logger LOG = LoggerFactory.getLogger(VerticaConnectionProvider.class);

	private static final long serialVersionUID = 1L;

	private final VerticaConnectionOptions jdbcOptions;

	private transient volatile Connection connection;

	public VerticaConnectionProvider(VerticaConnectionOptions jdbcOptions) {

...
public final class TableSimpleStatementExecutor implements VerticaBatchStatementExecutor<RowData> {
	 ...
	 */
	public TableSimpleStatementExecutor(StatementFactory stmtFactory, VerticaRowConverter converter) {

...
public class JdbcExecutionOptions implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return batchIntervalMs == that.batchIntervalMs
                ...
                && noUpdate == that.noUpdate
                && noDelete == that.noDelete;
    }
    ...
    public static final class Builder {
        ...
        public Builder withNoUpdate(boolean noUpdate) {
            this.noUpdate = noUpdate;
            return this;
        }
        ...
        public JdbcExecutionOptions build() {
            return new JdbcExecutionOptions(intervalMs, size, maxRetries, noUpdate, noDelete);
        }
    }
}

...
package org.apache.flink.connector.mysql.dialect;

import org.apache.flink.connector.mysql.internal.converter.JdbcRowConverter;
import org.apache.flink.connector.mysql.internal.converter.MySQLRowConverter;
...
public class MySQLDialect2 extends AbstractDialect {
    ...
    public Optional<String> getUpsertStatement(
        ...
        String updateClause =
                quoteIdentifier(uniqueKeyFields[0])
                        + "=VALUES("
                        + quoteIdentifier(uniqueKeyFields[0])
                        + ")";
        return Optional.of(

 ...
 */
public class VerticaOptions extends VerticaConnectionOptions {
	...
	private VerticaOptions(String dbURL, String tableName, String driverName, String username,
                           String password) {
	...
	public boolean equals(Object o) {
		if (o instanceof VerticaOptions) {
			VerticaOptions options = (VerticaOptions) o;
	...
	/**
	 * Builder of {@link VerticaOptions}.
	 */
	public static class Builder {
		...
		public VerticaOptions build() {
			checkNotNull(dbURL, "No dbURL supplied.");
			checkNotNull(tableName, "No tableName supplied.");
			checkNotNull(driverName, "No driverName supplied.");

			return new VerticaOptions(dbURL, tableName, driverName, username, password);
		}
	}
}
